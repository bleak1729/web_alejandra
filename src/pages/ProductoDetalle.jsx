    ...
    <div className="container-app py-12 grid md:grid-cols-2 gap-12">
      <div className="card aspect-square overflow-hidden">
        {p.imagenURL ? (
          ...
          <div className="w-full h-full bg-verde-100 flex items-center justify-center text-verde-300 font-serif text-6xl">
      ...
      <div>
        ...
        {sinStock && <p className="mt-6 text-terracota-400">Actualmente sin stock</p>}
